...
@Composable
fun ResenasHeader(resenas: List<DTOComentario>, promedio : Float ) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row (
            ...
            Text("Opiniones", fontWeight = FontWeight.SemiBold, fontSize = 14.sp)
        ...
        if (resenas.isEmpty()) {
            Column(
                ...
                Text("Sé el primero en opinar", fontWeight = FontWeight.SemiBold,
                    fontSize = 14.sp, color = Color.Gray)
                Text("Tus comentarios ayudan a otros usuarios",
                    fontSize = 12.sp, color = Color.LightGray, textAlign = TextAlign.Center)
            }
        } else {
            // Bloque del promedio
            Row(
